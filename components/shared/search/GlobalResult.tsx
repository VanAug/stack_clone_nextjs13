...
const GlobalResult = () => {
  ...
  const [result, setResult] = useState([
    ...
    { type: "tag", id: 2, title: "javascript" },
    { type: "user", id: 3, title: "react" },
  ]);
  ...
  return (
    <div className="absolute top-full z-10 mt-3 w-full rounded-xl bg-light-800 py-5 shadow-sm dark:bg-dark-500 ">
      <GlobalFilters />
